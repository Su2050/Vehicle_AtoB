...
gx_goal, gy_goal = dijkstra_grid._world_to_grid(dijkstra_grid.goal_x, dijkstra_grid.goal_y)
gx_start, gy_start = dijkstra_grid._world_to_grid(case['start']['x'], case['start']['y'])

print(f"Grid size: {dijkstra_grid.nx} x {dijkstra_grid.ny}")
print(f"Goal: {gx_goal}, {gy_goal}")
print(f"Start: {gx_start}, {gy_start}")
print(f"Start dist: {dijkstra_grid.dist_map[gx_start][gy_start]}")

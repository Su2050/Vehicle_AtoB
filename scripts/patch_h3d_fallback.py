...
# In planner_obs_v2.py, I made h_3d the primary heuristic.
# But h_3d is sometimes inf, which causes A* to fail immediately.
# Let's fallback to the 2D heuristic if h_3d is inf.
# Also, let's keep the RS heuristic.
